...
--- source/Plugins/Process/Utility/RegisterContextSunOS_x86_64.cpp.orig	2020-06-30 15:10:11.361168716 +0000
+++ source/Plugins/Process/Utility/RegisterContextSunOS_x86_64.cpp
@@ -0,0 +1,156 @@
+//===-- RegisterContextSunOS_x86_64.cpp ------------------------*- C++ -*-===//
+//
...
+//===----------------------------------------------------------------------===//
+
+#include "RegisterContextSunOS_x86_64.h"
...
+  GPR gpr;
+  FPR fpr;
+  // No access to debug registers on Solaris/illumos.
+};
+
...
+    std::unique_ptr<RegisterContextSunOS_i386> reg_interface(
+        new RegisterContextSunOS_i386(arch));
...
+}
+
+RegisterContextSunOS_x86_64::RegisterContextSunOS_x86_64(
+    const ArchSpec &target_arch)
+    : lldb_private::RegisterInfoInterface(target_arch),
+      m_register_info_p(GetRegisterInfoPtr(target_arch)),
+      m_register_count(GetRegisterInfoCount(target_arch)) {}
+
+size_t RegisterContextSunOS_x86_64::GetGPRSize() const { return sizeof(GPR); }
+
+const RegisterInfo *RegisterContextSunOS_x86_64::GetRegisterInfo() const {
+  return m_register_info_p;
+}
+
+uint32_t RegisterContextSunOS_x86_64::GetRegisterCount() const {
